...
class UserListProfileItemViewHolder(private val binding: LayoutListItemUserBinding) :
    UserListItemViewHolder<UserListItem.User>(binding.root) {
    ...
    override fun onBind(item: UserListItem.User) {
        with(binding) {
